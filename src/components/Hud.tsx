...
export default function Hud() {
  ...
  const robot = world.robots[selected];
  const robotColor = robot?.color ?? "#2dd4bf";
    ...
    <>
      <div id="hud">
        <div className="hud-row">
          <span>ROBOT</span>
          <b style={{ color: robotColor }}>{robotName}</b>
        </div>
        ...
        <div className="hud-row"><span>CATCHES</span><b>{catches}</b></div>
      ...
      <div id="legend">
        <span><i className="dot" style={{ background: "#ffe100" }} />target</span>
